<aside class="w-64 flex-shrink-0 bg-gray-950 text-gray-300 border-r border-gray-800 hidden sm:flex sm:flex-col h-screen sticky top-0">
    ...
    <div class="flex-1 overflow-y-auto px-4 py-6">
        <ul class="space-y-2 font-medium">
            ...
            <!-- Partners -->
            <li>
                <a href="{{route('admin.partners.index')}}" class="flex items-center p-3 rounded-lg hover:bg-gray-800 hover:text-white group">
            ...
            <!-- Ad Management -->
            <li>
                <a href="{{route('admin.ads.index')}}" class="flex items-center p-3 rounded-lg hover:bg-gray-800 hover:text-white group">
