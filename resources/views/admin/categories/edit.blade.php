            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-8 border-b border-gray-100 dark:border-gray-700 pb-4">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white">Edit Category: {{ $category->name }}</h3>
                    </div>
                    ...
                    <div class="max-w-2xl">
                        <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="space-y-6">
                            ...
                            <div class="flex items-center gap-4 pt-4">
                                ...
                                <a href="{{ route('admin.categories.index') }}" class="text-xs font-bold uppercase tracking-widest text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">
                                    Cancel
                                </a>
                            </div>
                        </form>
